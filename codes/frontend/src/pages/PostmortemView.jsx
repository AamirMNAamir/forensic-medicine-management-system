...
export default function PostmortemView() {
  ...
  if (error) {
    return (
      <Layout title="Postmortem Record">
  ...
  return (
    <Layout title="Postmortem Record" breadcrumb="Postmortem / View">
      ...
      <ConfirmDialog
        ...
        title="Issue Postmortem Report"
        message="Mark this PM report as issued and update the related case status to 'Report Issued'?"
        ...
        <div className="card-body">
          ...
          <div className="grid-3 mb-2">
            ...
            <div>
              ...
              <p className="font-bold">
                {pm.patient_name}, {pm.gender}, {pm.age} yrs
              </p>
            </div>
          ...
          <table>
            <tbody>
              <Row
                label="Immediate (Ia)"
                value={pm.cause_of_death_ia}
              />
              <Row
                label="Antecedent (Ib)"
                value={pm.cause_of_death_ib}
              />
              <Row
                label="Contributory (II)"
                value={pm.cause_of_death_ii}
              />
            </tbody>
          </table>
          ...
          <div className="grid-2">
            ...
            <div>
              ...
              <p style={{ whiteSpace: 'pre-wrap' }}>
                {pm.external_examination || 'Not recorded.'}
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ whiteSpace: 'pre-wrap' }}>
                {pm.internal_examination || 'Not recorded.'}
              </p>
            </div>
      ...
      >
        &larr; Back to Postmortem Records
      </Link>
